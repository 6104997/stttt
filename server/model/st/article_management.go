...
type ArticleManagement struct {
	...
	ArticleClassificationId string    `json:"article_classification_id" form:"article_classification_id" gorm:"default:0;column:article_classification_id;comment:文章分类ID;"` //文章分类ID
	AccountType             string    `json:"account_type" form:"account_type" gorm:"default:1;column:account_type;comment:账号类型;"`                                          //账号类型
