...
(function(module2, exports2) {
  (function(d, f2) {
    ...
    function g(a, e2) {
      var t2 = a.split(";").filter(m), r2 = t2.shift().split("="), s2 = r2.shift(), i = r2.join("=");
        ...
        for (r2 = t2, l = false; h(); )
          if (s2 = a.charAt(t2), s2 === ",") {
            for (i = t2, t2 += 1, h(), o2 = t2; t2 < a.length && c(); )
              t2 += 1;
            t2 < a.length && a.charAt(t2) === "=" ? (l = true, t2 = o2, e2.push(a.substring(r2, i)), r2 = t2) : t2 = i + 1;
          } else
            t2 += 1;
        (!l || t2 >= a.length) && e2.push(a.substring(r2, a.length));
      }
      return e2;
    }
    ...
    class b {
      ...
      set(e2 = "", t2 = "", r2 = {}) {
        ...
        let i = new _(Object.assign(r2, { name: e2, value: t2 })), o2 = this.__cookiesMap.get(s2) || /* @__PURE__ */ new Map();
      ...
      remove(e2 = "", t2 = "") {
        if (t2) {
          ...
          r2 && r2.delete(e2), r2 = this.__cookiesMap.get(k.normalizeDomain(t2)), r2 && r2.delete(e2);
        } else
      ...
      getCookie(e2 = "", t2 = "", r2 = "/") {
        ...
        for (let [o2, l] of this.__cookiesMap.entries())
          if (!(t2 && i.indexOf(o2) < 0)) {
            if (s2 = l.get(e2), s2 && s2.isInPath(r2) && !s2.isExpired())
              break;
            s2 = void 0;
          }
        return s2;
      ...
      parse(e2 = "", t2) {
        var r2 = y.parse(y.splitCookiesString(e2), { decodeValues: false });
        return r2.map((s2) => (s2.domain = k.normalizeDomain(s2.domain) || t2, new _(s2)));
      }
      stringify(e2) {
    ...
    return function() {
      ...
      const t2 = e2.bind(n2.request), r2 = e2.bind(n2.uploadFile), s2 = e2.bind(n2.downloadFile);
      try {
        Object.defineProperties(n2, { requestWithCookie: { value: t2 }, uploadFileWithCookie: { value: r2 }, downloadFileWithCookie: { value: s2 } }), Object.defineProperties(n2, { request: { value: t2 }, uploadFile: { value: r2 }, downloadFile: { value: s2 } });
      } catch (i) {
        console.error("weapp-cookie: ", i);
      }
      return a.config = function(i) {
        i = Object.assign({ requestAlias: "requestWithCookie", uploadFileAlias: "uploadFileWithCookie", downloadFileAlias: "downloadFileWithCookie" }, i), i.requestAlias && Object.defineProperty(n2, i.requestAlias, { value: t2 }), i.uploadFileAlias && Object.defineProperty(n2, i.uploadFileAlias, { value: r2 }), i.downloadFileAlias && Object.defineProperty(n2, i.downloadFileAlias, { value: s2 });
      }, a;
    }();
  });
})(weappCookie_umd);
