...
var weappCookie_umd = { exports: {} };
(function(module2, exports2) {
  (function(d, f2) {
    module2.exports = f2();
  })(commonjsGlobal, function() {
    var d = { exports: {} }, f2 = { decodeValues: true, map: false, silent: false };
    function m(a) {
      return typeof a == "string" && !!a.trim();
    }
    function g(a, e2) {
      var t2 = a.split(";").filter(m), r = t2.shift().split("="), s2 = r.shift(), i = r.join("=");
      e2 = e2 ? Object.assign({}, f2, e2) : f2;
      try {
        i = e2.decodeValues ? decodeURIComponent(i) : i;
      } catch (l) {
      ...
      var o2 = { name: s2, value: i };
      return t2.forEach(function(l) {
        var h = l.split("="), c = h.shift().trimLeft().toLowerCase(), u = h.join("=");
        c === "expires" ? o2.expires = new Date(u) : c === "max-age" ? o2.maxAge = parseInt(u, 10) : c === "secure" ? o2.secure = true : c === "httponly" ? o2.httpOnly = true : c === "samesite" ? o2.sameSite = u : o2[c] = u;
      }), o2;
    }
    function v(a, e2) {
      if (e2 = e2 ? Object.assign({}, f2, e2) : f2, !a)
        return e2.map ? {} : [];
      if (a.headers && a.headers["set-cookie"])
        a = a.headers["set-cookie"];
      else if (a.headers) {
        var t2 = a.headers[Object.keys(a.headers).find(function(s2) {
          return s2.toLowerCase() === "set-cookie";
        })];
        !t2 && a.headers.cookie && !e2.silent && console.warn("Warning: set-cookie-parser appears to have been called on a request object. It is designed to parse Set-Cookie headers from responses, not Cookie headers from requests. Set the option {silent: true} to suppress this warning."), a = t2;
      }
      if (Array.isArray(a) || (a = [a]), e2 = e2 ? Object.assign({}, f2, e2) : f2, e2.map) {
        var r = {};
        return a.filter(m).reduce(function(s2, i) {
          var o2 = g(i, e2);
          return s2[o2.name] = o2, s2;
        }, r);
      } else
        return a.filter(m).map(function(s2) {
          return g(s2, e2);
        });
    }
    function C(a) {
      ...
      if (typeof a != "string")
        return [];
      var e2 = [], t2 = 0, r, s2, i, o2, l;
      function h() {
        for (; t2 < a.length && /\s/.test(a.charAt(t2)); )
          t2 += 1;
        return t2 < a.length;
      }
      function c() {
        return s2 = a.charAt(t2), s2 !== "=" && s2 !== ";" && s2 !== ",";
      }
      for (; t2 < a.length; ) {
        for (r = t2, l = false; h(); )
          if (s2 = a.charAt(t2), s2 === ",") {
            for (i = t2, t2 += 1, h(), o2 = t2; t2 < a.length && c(); )
              t2 += 1;
            t2 < a.length && a.charAt(t2) === "=" ? (l = true, t2 = o2, e2.push(a.substring(r, i)), r = t2) : t2 = i + 1;
          } else
            t2 += 1;
        (!l || t2 >= a.length) && e2.push(a.substring(r, a.length));
      }
      return e2;
    }
    ...
    class x {
      getCookieScopeDomain(e2 = "") {
        if (!e2)
          return [];
        e2 = e2.replace(/^\.+/gi, "");
        let t2 = e2.split(".").map((r) => [".", e2.slice(e2.indexOf(r))].join(""));
        return [e2].concat(t2);
      }
      normalizeDomain(e2 = "") {
    ...
    class _ {
      ...
      set(e2 = "") {
        var t2 = y.parse(e2, { decodeValues: false })[0];
      ...
      isInDomain(e2) {
        return k.getCookieScopeDomain(e2).indexOf(this.domain) >= 0;
      }
      isInPath(e2) {
    ...
    class b {
      ...
      has(e2, t2, r) {
        return this.getCookie(e2, t2, r) !== void 0;
      }
      get(e2 = "", t2 = "", r = "/") {
        let s2 = this.getCookie(e2, t2, r);
      ...
      set(e2 = "", t2 = "", r = {}) {
        ...
        let i = new _(Object.assign(r, { name: e2, value: t2 })), o2 = this.__cookiesMap.get(s2) || /* @__PURE__ */ new Map();
        return o2.set(e2, i), this.__cookiesMap.set(s2, o2), this.__saveToStorage(), i;
      }
      dir() {
        let e2 = {};
      ...
      remove(e2 = "", t2 = "") {
        if (t2) {
          let r = this.__cookiesMap.get(t2);
          r && r.delete(e2), r = this.__cookiesMap.get(k.normalizeDomain(t2)), r && r.delete(e2);
        } else
      ...
      getCookie(e2 = "", t2 = "", r = "/") {
        let s2, i = k.getCookieScopeDomain(t2);
        for (let [o2, l] of this.__cookiesMap.entries())
          if (!(t2 && i.indexOf(o2) < 0)) {
            if (s2 = l.get(e2), s2 && s2.isInPath(r) && !s2.isExpired())
              break;
            s2 = void 0;
          }
        return s2;
      ...
      getCookiesArray(e2 = "", t2 = "/") {
        let r = [], s2 = k.getCookieScopeDomain(e2);
        for (let [i, o2] of this.__cookiesMap.entries())
          if (!(e2 && s2.indexOf(i) < 0))
            for (let l of o2.values())
              l.isInPath(t2) && !l.isExpired() && r.push(l);
        return r;
      }
      setCookiesArray(e2 = []) {
        return this.__cookiesMap = this.__cookiesMap || /* @__PURE__ */ new Map(), e2.forEach((t2) => {
          let r = this.__cookiesMap.get(t2.domain);
          r || (r = /* @__PURE__ */ new Map(), this.__cookiesMap.set(t2.domain, r)), r.set(t2.name, t2);
      ...
      getRequestCookies(e2, t2) {
        let r = this.getCookiesArray(e2, t2);
        return this.stringify(r);
      }
      setResponseCookies(e2, t2) {
        let r = this.parse(e2, t2);
        return this.setCookiesArray(r);
      }
      parse(e2 = "", t2) {
        var r = y.parse(y.splitCookiesString(e2), { decodeValues: false });
        return r.map((s2) => (s2.domain = k.normalizeDomain(s2.domain) || t2, new _(s2)));
      }
      stringify(e2) {
        ...
        try {
          ...
          for (let t2 of this.__cookiesMap.values())
            for (let r of t2.values())
              r.isExpired() ? t2.delete(r.name) : r.isPersistence() && e2.push(r);
          w.setItem(this.__storageKey, e2);
        } catch (e2) {
      ...
      __readFromStorage() {
        try {
          let e2 = w.getItem(this.__storageKey) || [];
          return e2 = e2.map((t2) => new _(t2)), this.setCookiesArray(e2);
        } catch (e2) {
    ...
    return function() {
      const a = new b();
      function e2(i) {
        if (i.cookie = i.cookie === void 0 || !!i.cookie, i.dataType = i.dataType || "json", i.header = i.headers = i.header || i.headers || {}, i.header["X-Requested-With"] = "XMLHttpRequest", i.dataType === "json" && (i.header.Accept = "application/json, text/plain, */*"), n2.platform !== "h5" && i.cookie) {
          let o2 = (i.url || "").split("/")[2], l = i.url.split(o2).pop(), h = a.getRequestCookies(o2, l);
          i.header.Cookie = h;
          let c = i.success;
          i.success = function(u) {
            u.header = u.header || u.headers;
            let p2 = u.header ? u.header["Set-Cookie"] || u.header["set-cookie"] : "";
            p2 && (p2 = p2.replace(/\;([^\s\;]*?(?=\=))/gi, ",$1"), a.setResponseCookies(p2, o2)), c && c(u);
          };
        }
        return this(i);
      }
      const t2 = e2.bind(n2.request), r = e2.bind(n2.uploadFile), s2 = e2.bind(n2.downloadFile);
      try {
        Object.defineProperties(n2, { requestWithCookie: { value: t2 }, uploadFileWithCookie: { value: r }, downloadFileWithCookie: { value: s2 } }), Object.defineProperties(n2, { request: { value: t2 }, uploadFile: { value: r }, downloadFile: { value: s2 } });
      } catch (i) {
        console.error("weapp-cookie: ", i);
      }
      return a.config = function(i) {
        i = Object.assign({ requestAlias: "requestWithCookie", uploadFileAlias: "uploadFileWithCookie", downloadFileAlias: "downloadFileWithCookie" }, i), i.requestAlias && Object.defineProperty(n2, i.requestAlias, { value: t2 }), i.uploadFileAlias && Object.defineProperty(n2, i.uploadFileAlias, { value: r }), i.downloadFileAlias && Object.defineProperty(n2, i.downloadFileAlias, { value: s2 });
      }, a;
    }();
  });
})(weappCookie_umd);
var weappCookie_umdExports = weappCookie_umd.exports;
const cookies = /* @__PURE__ */ getDefaultExportFromCjs(weappCookie_umdExports);
