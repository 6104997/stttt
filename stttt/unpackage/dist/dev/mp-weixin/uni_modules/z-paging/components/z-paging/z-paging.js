...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    bv: _ctx.useChatRecordMode && !_ctx.backToTopImg.length ? 1 : "",
    bw: _ctx.backToTopImg.length ? _ctx.backToTopImg : _ctx.base64BackToTop
  }, {
    bx: common_vendor.n(_ctx.finalBackToTopClass),
    by: common_vendor.s(_ctx.finalBackToTopStyle),
    bz: common_vendor.o((...args) => _ctx._backToTopClick && _ctx._backToTopClick(...args))
  }) : {}, {
    bA: _ctx.showLoading && _ctx.zSlots.loading && _ctx.loadingFullFixed
  }, _ctx.showLoading && _ctx.zSlots.loading && _ctx.loadingFullFixed ? {} : {}, {
    bB: !_ctx.usePageScroll ? 1 : "",
    bC: !_ctx.usePageScroll && _ctx.fixed ? 1 : "",
    bD: _ctx.usePageScroll ? 1 : "",
    bE: _ctx.renderPropScrollTop < 1 ? 1 : "",
    bF: _ctx.useChatRecordMode ? 1 : "",
    bG: common_vendor.s(_ctx.finalPagingStyle)
  });
}
