  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="房间号" prop="roomNumber">
         <el-input v-model="searchInfo.roomNumber" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="房间密码" prop="roomPassword">
         <el-input v-model="searchInfo.roomPassword" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateGoldenRoomFormFunc(scope.row)">变更</el-button>
...
import {
  ...
  deleteGoldenRoomForm,
  deleteGoldenRoomFormByIds,
  updateGoldenRoomForm,
  findGoldenRoomForm,
  getGoldenRoomFormList
...
const getTableData = async() => {
  const table = await getGoldenRoomFormList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteGoldenRoomFormByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateGoldenRoomFormFunc = async(row) => {
    const res = await findGoldenRoomForm({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteGoldenRoomFormFunc = async (row) => {
    const res = await deleteGoldenRoomForm({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
