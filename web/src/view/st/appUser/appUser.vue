       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="签到:"  prop="signIn" >
              <el-input v-model.number="formData.signIn" :clearable="true" placeholder="请输入签到" />
            </el-form-item>
            <el-form-item label="电话号:"  prop="phone" >
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="头像">
                            <el-image style="width: 50px; height: 50px" :preview-src-list="returnArrImg(detailFrom.headPortrait)" :src="getUrl(detailFrom.headPortrait)" fit="cover" />
                    </el-descriptions-item>
                    <el-descriptions-item label="openpid">
                        {{ detailFrom.openpid }}
                    </el-descriptions-item>
